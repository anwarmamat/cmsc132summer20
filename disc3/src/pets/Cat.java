 ...
 */
  int time;
	...
	/**
	 * Causing chaos makes loose 5 units of hunger, 5 units of energy
	 * and helps it gain 5 units of happiness.
	...
	/**
	 * Playing with the cat makes it loose 5 units of energy and
	 * 5 units of hunger. 
