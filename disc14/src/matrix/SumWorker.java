...
/**
 * This class represents the task of taking the sum of an indicated row or column of a
...
public class SumWorker implements Runnable{
	...
	private int[][] matrix;
	/**
	 * This variable is set to true if the sum of a row is to be taken and false if the 
	 * sum of a column is to be taken.
	 */
	 ...
	 */
	public SumWorker(int[][] matrix, boolean sumRow, int index, ArrayList<Integer> results){
		//TODO
	}
